...
def does_ext_exist(ext_id):
    return does_file_exist(data_center.get_exts_folder() + SEPARATE + ext_id + ".json")

def does_node_exist(node_id):
    return does_file_exist(data_center.get_nodes_folder() + SEPARATE + node_id + ".json")

def load_ext(ext_id):
    return load(data_center.get_exts_folder() + SEPARATE + ext_id + ".json")

def save_ext(ext_id, data):
    save(data_center.get_exts_folder() + SEPARATE + ext_id + ".json", data)
...
def add_ext(file_path):
    ...
    copy(file_path, data_center.get_exts_folder() + SEPARATE + ext_id + ".json")

def delete_ext(ext_id):
    delete(data_center.get_exts_folder() + SEPARATE + ext_id + ".json")

def load_node(node_id):
    return load(data_center.get_nodes_folder() + SEPARATE + node_id + ".json")

def save_node(node_id, data):
    save(data_center.get_nodes_folder() + SEPARATE + node_id + ".json", data)

def delete_node(node_id):
    delete(data_center.get_nodes_folder() + SEPARATE + node_id + ".json")
